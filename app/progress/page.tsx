      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4">
        <Card>
          <CardContent className="pt-6 text-center">
            <Library size={20} className="mx-auto text-lavender-400 mb-2" />
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            <CheckCircle2 size={20} className="mx-auto text-lavender-400 mb-2" />
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            <Heart size={20} className="mx-auto text-lavender-400 mb-2" />
        ...
        <Card>
          <CardContent className="pt-6 text-center">
            <BarChart3 size={20} className="mx-auto text-lavender-400 mb-2" />
              ...
              {[0, 1, 2, 3, 4, 5].map((level) => {
                ...
                return (
                  <div key={level} className="flex items-center gap-3">
                    ...
                    <div className="flex-1 h-5 bg-lavender-100 rounded-full overflow-hidden">
                      <div
                        className="h-full bg-lavender-300 rounded-full transition-all"
                        style={{ width: `${pct}%` }}
                      />
                    </div>
